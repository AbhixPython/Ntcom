...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b' SERVER RUNNING BY ABHI DON')
...
def validate_password():
    ...
    if pwd != password:
        print('Password Has Been Changed By Author..!! Please Contact Script Author Abhi... !! Thank You..')
        sys.exit()
